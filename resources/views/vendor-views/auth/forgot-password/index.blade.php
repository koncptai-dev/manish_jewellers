                    ...
                    <div class="card py-2 mt-4">
                        <form class="card-body needs-validation" action="{{route('vendor.auth.forgot-password.index') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="email" name="identity" id="recover-email" placeholder="{{ translate('enter_email_address') }}" required>
                                <div class="invalid-feedback">{{ translate('please_provide_valid_email_address.') }}</div>
                            </div>
                            <button class="btn btn-primary forget-password-form" type="button">
                                {{ translate('Send') }}
                            </button>
                        </form>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class=" mb-3">
                                    <input class="form-control form-control-user" name="identity"
                                           type="number" id="exampleInputPhone" value="{{ old('identity') }}"
