...
@section('title', translate('catalogue_Edit'))
            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-body text-start">
                        <form action="{{ route('admin.catalogue.update', [$catalogue->id]) }}" method="post" enctype="multipart/form-data" class="catalogue-setup-form">
                            @csrf
                            <!-- Use method spoofing for PUT or POST as per your route -->
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select name="brand_id" id="brand_id" class="form-control" required>
                                    ...
                                    @foreach($brands as $brand)
                                        <option value="{{ $brand->id }}" {{ $catalogue->brand_id == $brand->id ? 'selected' : '' }}>
                                            {{ $brand->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="catalogue_name" class="form-control" id="name"
                                           value="{{ old('catalogue_name', $catalogue->name) }}"
