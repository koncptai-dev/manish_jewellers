            ...
            <div class="card-body">
                ...
                <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form"
                    ...
                    <div class="form-group pt-2">
                        ...
                        <textarea
                            class="summernote {{ $lang == $defaultLanguage ? 'product-description-default-language' : '' }}"
                            name="description[]">{{ old('details') }}</textarea>
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <select class="js-select2-custom form-control action-get-request-onchange"
            ...
            <option value="{{ null }}" selected disabled>{{ translate('select_Sub_Category') }}
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3" id="digital_product_type_show">
                        <div class="form-group">
                            <label for="digital_product_type" class="title-color">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" step="0.01" placeholder="{{ translate('Making Charge') }}"
                                name="making_charges" id="making_charges" class="form-control" value required>
                ...
                <div class="row align-items-end">
                    <div class="col-md-6 col-lg-4 col-xl-3 d-none">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" step="0.01" placeholder="{{ translate('purchase_price') }}"
                                value="{{ old('purchase_price') }}" name="purchase_price" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" step="0.01" placeholder="{{ translate('unit_price') }}"
                                name="unit_price" value="{{ old('unit_price') }}" id="unit_price" class="form-control"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" step="0.01" placeholder="{{ translate('ex: 5') }}" name="tax"
                                id="tax" value="{{ old('tax') ?? 0 }}" class="form-control">
                            ...
                            <div>
                                <div class="custom_upload_input">
                                    ...
                                    <div class="img_area_with_preview position-absolute z-index-2">
                                        <img id="pre_img_viewer" class="h-auto aspect-1 bg-white d-none" src="dummy"
                                            alt="">
                                    </div>
                                    <div
