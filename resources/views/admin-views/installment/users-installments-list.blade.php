...
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning btn-sm withdraw-btn"
                                                ...
                                                data-plan-amount="{{ $installment->plan_amount }}"> {{-- Added data-plan-amount --}}
                                                Withdraw
                                            </button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="withdrawModalLabel">Withdraw Amount for <span id="modalUserName"></span> (Plan: <span id="modalPlanCode"></span>)</h5>
                ...
                <form id="withdrawForm">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="planAmountInput" name="plan_amount"> {{-- Added hidden input for plan_amount --}}
    ...
    <div class="modal fade" id="withdrawDetailsModal" tabindex="-1" role="dialog" aria-labelledby="withdrawDetailsModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="withdrawDetailsModalLabel">Withdrawal Details for <span id="detailsModalUserName"></span> (Plan: <span id="detailsModalPlanCode"></span>)</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    @push('script') {{-- Use @push and @endpush for scripts --}}
    <script>
                ...
                button.addEventListener('click', function() {
                    ...
                    fetch(`{{ url('admin/installments/withdrawal-history') }}/${installmentId}`, { // Ensure this route exists and is correct
                        ...
                        .then(data => {
                            ...
                            detailsModalRemainingWithdrawableSpan.textContent = fetchedRemainingWithdrawable.toFixed(2);
                            ...
                            if (data.history && data.history.length > 0) {
                                ...
                                withdrawalHistoryTableBody.innerHTML = `<tr><td colspan="3" class="text-center">No withdrawal history found.</td></tr>`;
                            }
                        })
                        .catch(error => {
                            console.error('Error fetching withdrawal history:', error);
                            withdrawalHistoryTableBody.innerHTML = `<tr><td colspan="3" class="text-center text-danger">Failed to load history.</td></tr>`;
                        });
                });
            });
    </script>
