...
return [
	...
	"new-messages.Digital_files_are_required!" => "New-messages.Digital files are required!",
	...
	"messages.All_Customers" => "Messages.All Customers",
	"messages.Active_Customers" => "Messages.Active Customers",
	"messages.Inactive_Customers" => "Messages.Inactive Customers",
	"Sort By" => "Sort By",
	...
	"set_how_vendor’s_recover_their_forgotten_passwords" => "Set how vendor’s recover their forgotten passwords",
	...
	"No installment payments found." => "No installment payments found.",
	"Total Yearly Payment" => "Total Yearly Payment",
	"The unit price must be greater than 0." => "The unit price must be greater than 0.",
	"silver rates" => "Silver rates",
	"Purchase Gold Weight" => "Purchase Gold Weight",
	...
	"top_rated_product_list_priority_setup_updated_successfully" => "Top rated product list priority setup updated successfully",
	"best_selling_product_list_priority_setup_updated_successfully" => "Best selling product list priority setup updated successfully",
	"coupon_updated_successfully" => "Coupon updated successfully",
	"select_vendor_is_required" => "Select vendor is required",
	"push_notification_successfully" => "Push notification successfully",
	"The tax field is required." => "The tax field is required.",
	"want_to_turn_Off_phonePe_as_the_Digital_Payment_method" => "Want to turn Off phonePe as the Digital Payment method",
	"when_a_customer_chooses_the_‘Offline Payment’_during_checkout_and_chooses_their_favorite_payment_method,_they_must_fill-up_all_the_required_information_to_confirm_payment" => "When a customer chooses the ‘Offline Payment’ during checkout and chooses their favorite payment method  they must fill-up all the required information to confirm payment",
	"attribute_updated_successfully" => "Attribute updated successfully",
	"no_withdraw_method_found" => "No withdraw method found",
	"offline payment requ..." => "Offline payment requ...",
	"Labour" => "Labour",
	"please_upload_the_right_file" => "Please upload the right file",
	...
	"color_images_is_required" => "Color images is required",
	"Online_Payment_History" => "Online Payment History",
	"you_can_add_multiple_input_fields_&_place_holders_and_define_them_as_‘Is_Required’,_so_customers_cannot_complete_offline_payment_without_adding_that_information" => "You can add multiple input fields & place holders and define them as ‘Is Required’  so customers cannot complete offline payment without adding that information",
	"loan payment request..." => "Loan payment request...",
	"loan installment pay..." => "Loan installment pay...",
	"Shipping cost is required!" => "Shipping cost is required!",
	"'nvOpzp; AND 1=1 OR (<'>iKO))," => " nvOpzp  AND 1=1 OR (   iKO)) ",
	"download_app_section" => "Download app section",
	"phonePe" => "PhonePe",
	"guest_User" => "Guest User",
	"successfully_review_updated" => "Successfully review updated",
	"Product_not_found_in_cart" => "Product not found in cart",
	"subscription mandate..." => "Subscription mandate...",
	"loans" => "Loans",
	"brand'dAKMsn<'>uZoMnT" => "Brand dAKMsn   uZoMnT",
	"select_sub_category" => "Select sub category",
	"add_new_employee" => "Add new employee",
	"customer_Not_Found" => "Customer Not Found",
	...
	"If you require any assistance or have feedback or suggestions about our site, you can email us at" => "If you require any assistance or have feedback or suggestions about our site  you can email us at",
	"use_your_registered_email." => "Use your registered email.",
	"we_will_send_you_a_temporary_OTP_in_your_email" => "We will send you a temporary OTP in your email",
	"must_use_registered_email" => "Must use registered email",
	...
	"catalogue" => "catalogue",
	"catalogue_Add" => "Catalogue Add",
	"catalogue_Setup" => "Catalogue Setup",
	"Select Brand" => "Select Brand",
	"catalogue_Name" => "Catalogue Name",
	"Summer Collection" => "Summer Collection",
	"summer_collection_image" => "Summer collection image",
	"Catalogue_added_successfully" => "Catalogue added successfully",
	"catalogue_List" => "catalogue List",
	"search_by_catalogue_name" => "Search by catalogue name",
	"catalogue_Logo" => "Catalogue Logo",
	"catalogue_Edit" => "Catalogue Edit",
	"Catalogue_updated_successfully" => "Catalogue updated successfully",
	"if_enabled_this_catalogue_will_be_available_on_the_website_and_customer_app" => "If enabled this catalogue will be available on the website and customer app",
