...
return [
	...
	"want_to_delete_this_address?" => "Want to delete this address ",
	"500" => "500",
	"this_wallet_balance_can_be_used_for_product_purchase_and_if_want_to_add_more_fund_to_wallet,_click_on_add_fund" => "This wallet balance can be used for product purchase and if want to add more fund to wallet  click on add fund",
