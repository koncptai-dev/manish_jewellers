...
// Route::get('/callback', [\App\Http\Controllers\PaymentController::class, 'paymentCallback'])->name('payment.callback');
...
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode', 'guestCheck']], function () {
    ...
    Route::controller(ProductDetailsController::class)->group(function () {
        ...
        Route::post('/variant-product-size-price', 'getVariantProductPrice')->name('product-size-price');
    });
...
if (!$isGatewayPublished) {
    Route::group(['prefix' => 'payment'], function () {
        ...
        Route::group(['prefix' => 'phonePe', 'as' => 'phonePe.'], function () {
            Route::get('pay', [PhonePeController::class, 'initiatePaymentPage']);
            Route::get('/payment/callback/{merchantOrderId}', [PhonePeController::class, 'paymentStatus'])->name('payment.callback');
        });
