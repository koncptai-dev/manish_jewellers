...
use App\Http\Controllers\Admin\LoadRequestController;
...
Route::prefix('admin')->group(function () {
    ...
    Route::get('silver/{id}/edit', [SilverRateController::class, 'edit'])->name('admin.silver.edit');
    Route::put('silver/{id}', [SilverRateController::class, 'update'])->name('admin.silver.update');
    Route::delete('silver/{id}', [SilverRateController::class, 'destroy'])->name('admin.silver.destroy');
    Route::get('payment-history', [PaymentHistoryController::class, 'index'])->name('admin.payment-history');
    Route::get('/installments/{id}', [PaymentHistoryController::class, 'show'])->name('installments.show');

    Route::get('/payment-requests', [PaymentRequestController::class, 'index'])->name('admin.paymentRequests.index');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'products', 'as' => 'products.', 'middleware' => ['module:product_management']], function () {
        Route::controller(ProductController::class)->group(function () {
            ...
            Route::post(Product::CALCULATE_UNITPRICE[URI], 'calculateUnitPrice')->name('calculateUnitPrice');
