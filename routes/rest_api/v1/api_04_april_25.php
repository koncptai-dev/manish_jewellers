...
Route::group(['namespace' => 'RestAPI\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
   ...
   //PhonePay
    //Route::post('/phonepe/payment', [PhonePeController::class, 'createPayment']);  
   // Route::post('/online-payment', [PhonePeController::class, 'createPayment'])->name('phonepe.pay')->middleware('auth:api');
   Route::post('/online-payment', [PhonePeController::class, 'mobilePhonePeOrderCreate'])->name('phonepe.pay')->middleware('auth:api');
