...
class ProductListController extends Controller
{
    ...
    public function default_theme($request): View|JsonResponse|Redirector|RedirectResponse
    {
        ...
        // Apply transform
        // $productListData = $productListData->transform(function ($product) {
        //     // Calculate the price and assign it back to the product object
        //     $product->unit_price = Helpers::calculatePrice(
