...
class HomeController extends Controller
{
    ...
    public function default_theme(): View
    {
        ...
        $featuredProductsList->getCollection()->transform(function ($product) {
            ...
            $product->unit_price = Helpers::calculatePrice(json_decode($product->choice_options), $product->unit_price);
            return $product;
        });
        ...
        $latestProductsList->transform(function ($product1) {
            $product1->unit_price = Helpers::calculatePrice(json_decode($product1->choice_options), $product1->unit_price);
            return $product1;
        });
