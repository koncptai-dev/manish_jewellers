...
class InstallmentPaymentController extends Controller
{
    ...
    public function getCustomerPaymentRequest(Request $request, $orderAdditionalData = []): mixed
    {
        $additionalData = [
            ...
            // 'payment_mode' => $request->has('payment_request_from') ? $request['payment_request_from'] : 'web',
        ];
        ...
        if (in_array($request['payment_request_from'], ['app'])) {
            ...
            $additionalData['payment_of'] = $request['installment_payment'];
            $additionalData['installment_payment_id'] = $request['id'];
