...
class ProductController extends BaseController
{
    ...
    {
        $product = $this->productRepo->getFirstWhereWithoutGlobalScope(params: ['id' => $id], relations: ['translations', 'seoInfo', 'digitalProductAuthors.author', 'digitalProductPublishingHouse.publishingHouse']);
    ...
    public function getProductGalleryView(Request $request): View
    {
        $searchValue = $request['searchValue'];
        $filters     = [
            'added_by'            => ($request['vendor_id'] == 'in_house' || $request['added_by'] == 'in_house') ? 'in_house' : '',
            'searchValue'         => $searchValue,
            'request_status'      => 1,
    ...
    public function calculateUnitPrice(Request $request)
    {
        ...
        $price = Helpers::calculatePrice($choiceOptions, $unit_price, $making_charges, $metal);
