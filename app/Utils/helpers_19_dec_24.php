...
class Helpers
{
    ...
    public static function set_data_format($data)
    {
        ...
        $data['unit_price'] = Helpers::calculatePrice($data->choice_options, $data['unit_price'], $data['making_charges']);

        return $data;
    }

    public static function calculatePrice($choiceOptions, $unit_price, $making_charges)
    {
