...
class Helpers
{
    ...
    public static function getCustomerInformation($request = null)
    {
        ...
        if (auth('customer')->check()) {
            ...
            $user = (isset($request['is_guest']) && $request['is_guest'] == 'offline') ? 'offline' : User::find($request['customer_id']);
    ...
    public static function set_data_format($data)
    {
        ...
        $data['unit_price'] = Helpers::calculatePrice($data->choice_options, $data['unit_price'], $data['making_charges'], $data['product_metal']);
