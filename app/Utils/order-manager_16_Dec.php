...
class OrderManager
{
    ...
    public static function saveInstallmentPayment($data)
    {
        ...
        if ($data->installment_payment_id > 0)
            // Use the model method to create the data
            $installmentPayment = InstallmentPayment::updateWithDetails($data, $data['details']);
        else
            // Use the model method to create the data
            $installmentPayment = InstallmentPayment::createWithDetails($data, $data['details']);
